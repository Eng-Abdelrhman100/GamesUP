        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              {stats.map((stat, idx) => (
                <div key={idx} className="bg-bg-card border border-border-subtle rounded-3xl p-6 flex items-center justify-between group hover:border-brand-red/30 transition-all">
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {actions.map((action, idx) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[var(--text-primary)] uppercase italic tracking-tighter mb-2 group-hover:text-brand-red transition-colors">{action.label}</h3>
            ...
            <div className="bg-bg-card border border-border-subtle rounded-[2.5rem] p-10">
              <div className="flex items-center justify-between mb-8">
                ...
                <button onClick={() => onViewChange('orders')} className="text-[10px] font-black text-brand-red hover:underline uppercase tracking-widest italic flex items-center gap-2">
              ...
              <div className="space-y-4">
                {[1, 2].map((i) => (
                  <div key={i} className="flex items-center justify-between p-5 bg-bg-dark border border-border-subtle rounded-2xl group hover:border-brand-red/20 transition-all">

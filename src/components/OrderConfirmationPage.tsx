...
import { CheckCircle2, Package, ArrowRight, Download, Share2, ShieldCheck, Zap } from 'lucide-react';
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-6 bg-bg-dark/50 rounded-2xl border border-border-subtle/50 text-left">
                ...
                <p className="text-[9px] text-text-secondary font-bold uppercase leading-relaxed">Your digital access codes are being generated. This process takes 5-15 minutes.</p>
              </div>
              <div className="p-6 bg-bg-dark/50 rounded-2xl border border-border-subtle/50 text-left">
                ...
                <p className="text-[9px] text-text-secondary font-bold uppercase leading-relaxed">You will receive an encrypted transmission via your registered frequency (email).</p>
              </div>
            </div>
          </div>
        </div>

        ...
        <>
          ...
          >
            ...
            <div className="p-6 border-b border-border-subtle flex items-center justify-between">
              ...
              <button 
                onClick={onClose}
                className="p-2 hover:bg-border-subtle rounded-full transition-colors text-text-secondary"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
                ...
                items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      ...
                      <p className="font-black text-base tracking-tighter">{item.price} <span className="text-[10px] text-text-secondary">L.E</span></p>
                    </div>
                    <button 
                      onClick={() => onRemove(item.cartId)}
                      className="p-2 h-fit text-text-secondary hover:text-brand-red transition-colors"
                    >
            ...
            {items.length > 0 && (
              <div className="p-8 border-t border-border-subtle bg-bg-secondary/50">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-2xl font-black text-[var(--text-primary)] tracking-tighter">{total} <span className="text-xs">L.E</span></span>
                </div>
                <button 

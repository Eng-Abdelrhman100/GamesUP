...
import { ChevronRight, Target, Zap, Shield, Swords } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((cat, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              onClick={() => onCategoryClick(cat.id === 'rpg' ? 'RPG' : cat.id === 'sports' ? 'SPORTS' : cat.id === 'shooter' ? 'SHOOTER' : cat.id === 'horror' ? 'HORROR' : 'ALL')}

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <h1 className="text-5xl md:text-8xl font-black tracking-[-0.05em] text-[var(--text-primary)] uppercase font-display leading-[0.8] italic mb-12">
              THE<br />SAMURAI<br /><span className="text-brand-red">WAY.</span>
            </h1>
            <div className="space-y-6 text-text-secondary text-lg leading-relaxed font-medium italic">
              <p>
                Founded in the digital trenches of Egypt, Samurai Store was born from a singular mission: to provide the elite gaming community with the most secure and rapid asset deployment in the territory.
              </p>
              <p>
                We don't just sell accounts; we provide keys to new dimensions. Every mission we undertake is backed by our triple-layer security protocol, ensuring your digital honor remains intact.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-10 rounded-[2.5rem] bg-bg-card border border-border-subtle hover:border-brand-red/30 transition-all flex flex-col items-center text-center group md:col-span-2">
              ...
              <p className="text-xs text-text-secondary font-bold uppercase tracking-widest leading-loose">Dedicated Egyptian operators standing by 24/7 to ensure your mission success.</p>
            </div>
          </div>
        </div>
      </div>

...
import { Gamepad2, Zap, Play, Star, Cpu } from 'lucide-react';
...
export const Preloader = ({ onLoadingComplete }: { onLoadingComplete: () => void }) => {
  ...
  return (
    ...
    >
      {/* Drifting Game Covers in Background */}
        ...
        <div className="w-72 space-y-8">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] italic text-white/80">

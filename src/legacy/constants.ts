...
export const GAMES_DATA: Game[] = [
  {
    ...
    status: 'OUT OF STOCK',
    description:
      'Follow the grim tale of young Amicia and her little brother Hugo, in a heart-rending journey through the darkest hours of history.',
    accountTypes: [
  ...
  },
  {
    ...
    banner: '/assets/red banner 3.jpg',
    price: 300,
    basePrice: 300,
    category: 'Action',
    tags: ['Adventure', 'New'],
  ...
  },
  {
    id: '4',
    title: 'FC 24',
    image: '/assets/red consolr.jpg',
    banner: '/assets/ps banner.jpg',
    price: 600,
    basePrice: 600,
    category: 'Sports',
    ...
    status: 'IN STOCK',
    description:
      'EA SPORTS FC 24 is a new era for The World’s Game: 19,000+ fully licensed players, 700+ teams, and 30+ leagues playing together.',
    accountTypes: [

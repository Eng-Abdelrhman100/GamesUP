              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {game.accountTypes.map((option, idx) => (
                    ...
                    >
                      <div
                        className={`p-4 rounded-2xl transition-all ${selectedTier === idx ? 'bg-brand-red text-white scale-110 shadow-lg shadow-brand-red/30' : 'bg-bg-dark text-text-secondary'}`}
                      >

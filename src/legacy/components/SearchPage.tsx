...
import { ArrowRight, Heart, History, Search, Shield, TrendingUp, X, Zap } from 'lucide-react';
...
export const SearchPage = ({ onBack, onProductClick, favorites, onToggleFavorite }: SearchPageProps) => {
  ...
  const trendingAssets = GAMES_DATA.slice(0, 4);
        ...
        <div className="mb-16">
          <div className="relative group max-w-4xl">
            ...
            <div className="relative flex items-center bg-bg-card border-2 border-border-subtle group-focus-within:border-brand-red rounded-[2rem] p-6 transition-all shadow-2xl">
              ...
              />
              {query && (
                <button onClick={() => setQuery('')} className="p-3 hover:bg-bg-dark rounded-xl transition-all">
          ...
          <div className="lg:col-span-8">
            <AnimatePresence mode="wait">
              {query.trim().length > 1 ? (
                    ...
                    {isSearching && (
                      <div className="flex gap-1">
                        ...
                        <motion.div
                          ...
                          className="w-1 h-4 bg-brand-red"
                        />
                        <motion.div
                          animate={{ opacity: [0.2, 1, 0.2] }}
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className={`p-1.5 rounded-lg transition-all ${
                                    favorites.includes(game.id) ? 'text-brand-red' : 'text-text-secondary hover:text-brand-red'
                                  }`}
                                >
                ...
                <motion.div key="suggestions" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-12">
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <div className="bg-brand-red p-8 rounded-[2rem] relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-[9px] text-white/80 font-bold uppercase tracking-widest mb-6 leading-relaxed italic">
                  If you can't find the tactical asset you require, our operations team can source it directly.
                </p>
                <button className="px-6 py-3 bg-white text-brand-red rounded-xl text-[9px] font-black uppercase tracking-widest hover:scale-105 transition-all italic">

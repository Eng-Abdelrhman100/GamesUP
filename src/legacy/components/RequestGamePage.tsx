...
import { ArrowLeft, Gamepad2, Info, Send, Upload, X } from 'lucide-react';
            ...
            <div className="space-y-8">
              <div className="p-6 rounded-3xl bg-brand-red/5 border border-brand-red/20">
                ...
                <p className="text-xs text-text-secondary font-bold uppercase tracking-widest leading-loose">
                  Can't find your target in our armory? Submit a request and our procurement specialists will scan the network to secure the asset
                  for you.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div
                  ...
                  className={`relative group h-48 border-2 border-dashed rounded-3xl flex flex-col items-center justify-center gap-4 transition-all overflow-hidden ${
                    imagePreview ? 'border-brand-red bg-brand-red/5' : 'border-border-subtle hover:border-brand-red/30 bg-bg-dark cursor-pointer'
                  }`}
                >
                  {imagePreview ? (
                    <>

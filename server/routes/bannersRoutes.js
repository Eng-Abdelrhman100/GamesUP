...
bannersRoutes.post('/banners', requirePermission('banners', 'write'), async (req, res) => {
  try {
    const b = req.body || {};
...
bannersRoutes.put('/banners/:id', requirePermission('banners', 'write'), async (req, res) => {
  try {
...
bannersRoutes.delete('/banners/:id', requirePermission('banners', 'write'), async (req, res) => {
  try {
    const id = req.params.id;
